defmodule HTTPizzaWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HTTPizzaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HTTPizzaWeb.Gettext, "errors", msg, opts)
    end
  end
