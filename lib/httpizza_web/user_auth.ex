defmodule HTTPizzaWeb.UserAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_httpizza_web_user_remember_me"
  ...
  def log_out_user(conn) do
    ...
    user_token && IAM.delete_user_session_token(user_token)

    if live_socket_id = get_session(conn, :live_socket_id) do
      HTTPizzaWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  def fetch_current_user(conn, _opts) do
    ...
    user = user_token && IAM.get_user_by_session_token(user_token)
  ...
  Or use the `live_session` of your router to invoke the on_mount callback:
      ...
      live_session :authenticated, on_mount: [{HTTPizzaWeb.UserAuth, :ensure_authenticated}] do
