...
config :httpizza, HTTPizzaWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "rNkmv6AFlSwpKZaZ9EcA+ip2Fon0xKdVNlWmUlD69F2shK9MfufK3Ye1HHzUwzu6",
  watchers: [
...
config :httpizza, HTTPizzaWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/httpizza_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :httpizza, dev_routes: true
